...
There are of course a few <big>deprecated</big> <acronym title="HyperText Markup Language">HTML</acronym> elements, so why not <font color="#2FCF6F" face="times" size="5">include</font> them here at the end.
